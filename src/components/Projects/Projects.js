export const projects = [
    ...
    //     description: "Finished a 10-hour course on web development and earned a certificate",
    //     bg: "bg-[linear-gradient(90deg,_rgba(0,51,102,1)_0%,_rgba(0,102,204,1)_50%,_rgba(0,153,255,1)_100%)] dark:bg-[linear-gradient(90deg,_rgba(0,51,102,0.6)_0%,_rgba(0,102,204,0.65)_50%,_rgba(0,153,255,0.70)_100%)] transition-colors duration-200",
