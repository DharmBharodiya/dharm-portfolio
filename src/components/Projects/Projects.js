export const projects = [
  {
    ...
    flowerClass:
      "absolute md:w-15 md:h-15 w-10 h-10 md:-top-7 md:right-55 -top-5 right-20",
    src: "https://secondbrain-mocha.vercel.app/",
  },
  {
    title: "GREP - Smart GRE Tutor",
    description:
      "Personalized tool that leverages AI to help with GRE preparation",
    bg: "bg-[linear-gradient(90deg,_rgba(2,0,36,1)_0%,_rgba(9,9,121,1)_50%,_rgba(0,212,255,1)_100%)] dark:bg-[linear-gradient(90deg,_rgba(2,0,36,0.65)_0%,_rgba(9,9,121,0.60)_50%,_rgba(0,212,255,0.70)_100%)] transition-colors duration-200",
  ...
  },
  {
    ...
    description:
      "A minimal crypto info app built to learn fundamental concepts of react.(routing, searching, filtering)",
    ...
    flowerClass: "absolute md:w-15 md:h-15 w-10 h-10 -bottom-4 left-0",
  ...
  },
  {
    ...
    description:
      "Designed and developed a portfolio website to showcase projects and skills",
